...
def experience():
    ...
    experience_entries = [
        ...
        },
        {
            ...
            "description": [
                ...
                "Assisted project managers with risk logs, project status, and resource scheduling for 10 projects and a team of 25.",
                "Managed and updated the CRM with 500+ client records with their property listings."
            ],
    ...
    # Render the experience entries in a two-column layout
        ...
        with current_col:
            ...
            if "description" in exp:
                ...
                for item in exp["description"]:
                    st.markdown(f"<li style='font-size: 13px; color: #4a5568;'>{item}</li>", unsafe_allow_html=True)
