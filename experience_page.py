...
def experience():
    ...
    experience_entries = [
        ...
        },
        {
            ...
            "description": """
                    <ol>
                        <li>As an overview engineer in a government-owned organization specializing in avionics and electronic warfare.</li>
                        <li>Took on the responsibility of product management, focusing product life cycle of RWR (Radio warning receiver)</li>
                        <li>Performed quality testing’s and operated THV (temperature, humidity, and vibration) chamber.</li>
                    </ol>
            """,
